...
<template>
  <div class="relative bg-gradient-to-b from-top-deg  to-bot-deg min-h-screen">
    ...
    <div class="flex flex-col items-center justify-center min-h-screen p-4 sm:p-8">
      <img src="../components/animations/Anima.gif" alt="GIF animé" class="mb-10 lg:w-24 lg:h-24 md:w-16 md:h-16 w-12 h-12 mt-20">
      <h1 class="text-3xl md:text-6xl lg:text-7xl text-white font-titre -mb-4">Ethan Schmitt</h1>
      <h2 class="text-4xl md:text-7xl lg:text-8xl font-titre shine-text">Web developer</h2>
      <triforce class=" lg:w-65 lg:h-49 absolute -bottom-10 left-0  md:w-16 md:h-16 w-10 h-8 "  />
    </div>
    <div class="w-2/3 h-1 bg-white my-12 justify-center mx-auto"></div>
    ...
    <div class="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-52 p-8 md:p-12">
      ...
      <img src="../components/icons/pp.png" alt="Photo de profil" class="w-28 h-28 md:w-40 md:h-40 lg:w-56 lg:h-56 rounded-full object-cover shadow-lg">
    </div>
  </div>
</template>
